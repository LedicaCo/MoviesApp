import '../../assets/css/actorsForm.css';
    ...
    return (
        ...
        >
            <Form>
                <Row className="mb-3">
                    <Col xs={9}>
                        <FloatingLabel label="Image URL" className='color-label'>
                            <Form.Control className='bg-inputs-form'
                                required 
                ...
                <Row className="mb-3">
                    <Col>
                        <FloatingLabel label="First name" className='color-label'>
                            <Form.Control className='bg-inputs-form'
                                required 
                    ...
                    <Col>
                        <FloatingLabel label="Last name" className='color-label'>
                            <Form.Control className='bg-inputs-form'
                                required 
                ...
                <Row className="mb-3" >
                    <Col>
                        <FloatingLabel label="Nationality" className='color-label'>
                            <Form.Control className='bg-inputs-form'
                                required
                    ...
                    <Col>
                        <FloatingLabel label="Birthday" className='color-label'>
                            <Form.Control className='bg-inputs-form'
                                required 
                                type="date" 

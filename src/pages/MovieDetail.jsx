                ...
                <Col>
                    ...
                    <ListGroup horizontal>
                        {movie.genres?.map(genre => (
                            <ListGroup.Item key={genre.id} className='genre-item'>
                                {genre.name}
                            </ListGroup.Item>
                        ))}
                    </ListGroup>
                    <p className="mt-3 ry"><b className='ry-subtitle'>Release year:</b> {movie.releaseYear}</p>
                    <p className='text-synopsis'>{movie.synopsis}</p>
                    ...
                    <h3 className="mt-5 actors-title">Actors</h3>
                    <Row xs={1} sm={2} xl={3} className="g-4">

import '../assets/css/movieForm.css';
...
const MovieForm = () => {
    ...
    return (
        <>
            <Row>
                <Col>
                    <FloatingLabel label="Image url" className="mb-4 color-label">
                        <Form.Control className='bg-inputs'
                ...
                <Col sm={9} md={8} xl={9}>
                    ...
                    <input
                        className="movie-name-input mb-5 bg-inputs"
                    ...
                    <div className="d-flex justify-content-between align-items-star ">
                        ...
                        <Button variant="outline-success" className='btn-br' size="sm" onClick={() => openForm("genres")}>
                            Add genre
                        </Button>
                    </div>
                    <ItemsSelect className="bg-inputs"
                        items={genres}
                        itemStructure={genre => <Card.Body className="text-ghostwhite">{genre.name}</Card.Body>}
                        itemsSelected={movie.genres}
                        setItemsSelected={e => editMovie("genres", e)}
                    />


                    <FloatingLabel label="Release year" className="mb-4 color-label" style={{maxWidth: 200}}>
                        <Form.Control className='bg-inputs'
                    ...
                    <FloatingLabel label="Synopsis" className="mt-3 color-label">
                        <Form.Control className='bg-inputs'
                    ...
                    <div className="d-flex justify-content-between align-items-start mt-4">
                        <h3 className='directors-title'>Directors</h3>
                        <Button variant="outline-success" className='btn-br' size="sm" onClick={() => openForm("directors")}>
                            Add Director
                        </Button>
                    </div>
                    <ItemsSelect
                    ...
                    <div className="d-flex justify-content-between align-items-start mt-4">
                        ...
                        <Button variant="outline-success" className='btn-br' size="sm" onClick={() => openForm("actors")}>
                            Add actor
                        </Button>
                    </div>
                    <ItemsSelect
            ...
            <div className="options-movie-buttons">
                <Button
                    /* variant="success" */className='btn-save'
                    size='lg'
                    onClick={saveMovie}
                >
                    Save movie
